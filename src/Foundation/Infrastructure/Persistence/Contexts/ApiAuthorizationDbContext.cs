    ...
    where TKey : IEquatable<TKey>
{
    ...
    ///     <see cref="T:Aviant.Foundation.Infrastructure.Persistence.Contexts.ApiAuthorizationDbContext`3" />.
    /// </summary>
    ...
    where TUser : IdentityUser
{
    ...
    /// <summary>
    ///     Initializes a new instance of
    ///     <see cref="T:Aviant.Foundation.Infrastructure.Persistence.Contexts.ApiAuthorizationDbContext`1" />.
    /// </summary>
    /// <param name="options">The <see cref="T:Microsoft.EntityFrameworkCore.DbContextOptions" />.</param>
    /// <param name="operationalStoreOptions">The <see cref="T:Microsoft.Extensions.Options.IOptions`1" />.</param>
    public ApiAuthorizationDbContext(
